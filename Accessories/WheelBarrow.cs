...
{
    public class WheelBarrow : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetDamage (ModContent.GetInstance<FloraDamageClass>()) += 0.5f; 
            ...
            player.GetAttackSpeed(ModContent.GetInstance<FloraDamageClass>()) += 0.5f;
